...
This is the Android client and phone-hosted server for SyncWatch同步观影 v2.1.8. The APK
...
The verified artifact is written to `SyncWatch同步观影-v2.1.8.apk`.
...
powershell -NoProfile -ExecutionPolicy Bypass -File .\tests\android-package.ps1 -ApkPath .\mobile\SyncWatch同步观影-v2.1.8.apk
```
