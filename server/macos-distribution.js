...
function releaseVersion(value) {
  const normalized = String(value || '2.1.7').trim().replace(/^v/i, '');
  return /^\d+\.\d+\.\d+(?:[-+][0-9A-Za-z.-]+)?$/.test(normalized) ? normalized : '2.1.7';
}

function macArtifactFilename(kind, architecture, format, version = '2.1.7') {
...
function createMacDistribution({
  kind, version = '2.1.7', legacyPaths = {}, configured = {}, roots = [],
