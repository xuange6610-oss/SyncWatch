...
const guides = [
  ...
  ['macos-build', 'macOS 构建与发布', 'MACOS BUILD', '说明 Intel 与 Apple Silicon 的构建准备、签名边界、产物校验和发布方式。', 'macos-build.md', ['main-interface.png', 'project-cover.png']],
  ...
  ['release-artifacts', '发布文件与下载说明', 'RELEASE ARTIFACTS', '解释体验版、标准版、完整版、独立服务器、Android 和 macOS 文件分别做什么，以及如何校验。', 'release-artifacts.md', ['project-cover.png', 'main-interface.png']],
