...
产物为 `release/server-deployment/SyncWatch同步观影-Server-v2.1.5.zip`，包含服务器源码、网页、APK、启动脚本、Docker 文件、部署文档和锁定的 Windows x64 生产依赖，不包含 Electron、测试目录、开发缓存和 Android 私钥。
