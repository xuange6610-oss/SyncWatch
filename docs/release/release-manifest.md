...
v2.1.7 和 v2.1.8 的 Release API 均已验证有 26 个维护者资产，加上 GitHub 自动源码归档后各为 28 个可见文件。v2.1.9 只有在真实构建、哈希和 Release API 校验完成后，才能声明达到相同的 26 + 2 清单；不能因为 README 或公告列出名称就视为文件已经上传。
