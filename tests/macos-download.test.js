...
async function main() {
  ...
  const discovered = macDistribution.createMacDistribution({
    kind: 'server', version: 'v2.1.5', roots: [artifactsDir], includeDefaultRoots: false,
  ...
  const rejectedLocalArtifacts = macDistribution.createMacDistribution({
    kind: 'server', version: 'v2.1.5', roots: [], includeDefaultRoots: false, env: {},
    configured: {
  ...
  const bridged = macDistribution.createMacDistribution({
    kind: 'client', version: 'v2.1.5', legacyPaths: normalizedBridge,
